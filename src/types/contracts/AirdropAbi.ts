...
export interface AirdropAbi extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): AirdropAbi;
  clone(): AirdropAbi;
  methods: {
    AIRDROP_STARTER_ROLE(): NonPayableTransactionObject<string>;

    DEFAULT_ADMIN_ROLE(): NonPayableTransactionObject<string>;

    airdropNumber(): NonPayableTransactionObject<string>;

    claim(
      airdropID: number | string | BN,
    ...
    getToken(token: string, amount: number | string | BN): NonPayableTransactionObject<void>;
    ...
    log(arg0: number | string | BN): NonPayableTransactionObject<{
      token: string;
      merkleRoot: string;
      0: string;
      1: string;
    ...
    setTokenForNextAirdrop(_token: string): NonPayableTransactionObject<void>;

    startNewAirdrop(_merkleRoot: string | number[]): NonPayableTransactionObject<void>;

    supportsInterface(interfaceId: string | number[]): NonPayableTransactionObject<boolean>;

    tokenForNextAirdrop(): NonPayableTransactionObject<string>;
  };
  events: {
