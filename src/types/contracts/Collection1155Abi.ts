...
export interface Collection1155Abi extends BaseContract {
  constructor(jsonInterface: any[], address?: string, options?: ContractOptions): Collection1155Abi;
  clone(): Collection1155Abi;
  methods: {
